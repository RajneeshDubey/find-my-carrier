...
export interface LinkProps extends React.DetailedHTMLProps<React.AnchorHTMLAttributes<HTMLAnchorElement>, HTMLAnchorElement> {
    ...
    href?: string;
    /**
     * The event handler for the anchor.
     */
