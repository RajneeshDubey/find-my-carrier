...
export interface SelectProps extends Omit<React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "onChange"> {
    /**
     * The custom classname for the root div of the component
     */
    className?: string;
    /**
     * The disabled attribute for the select component.
     */
    disabled?: boolean;
    /**
     * The error for the select component.
     */
